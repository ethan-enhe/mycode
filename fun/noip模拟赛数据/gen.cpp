...
int main(int argc, char *argv[]) {
    ...
    if (randint(1, 3) == 1) {
        ll x = randint(1, 3);
        switch (x) {
            case 1: cout << randint(1, 2) << " " << randint(1, MXN) << "\n"; break;
            case 2: cout << randint(1, 2) << " " << randint(1, 2) << "\n"; break;
            default: cout << randint(1, MXN) << " " << randint(1, 2) << "\n"; break;
        }
    }
    else cout<<randint(1, MXN)<<" "<<randint(1, MXN);
    return 0;
}
