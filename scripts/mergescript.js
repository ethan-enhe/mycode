...
const rules = [
  // --- 新增 Gemini API 内联规则 ---
  "DOMAIN-SUFFIX,generativelanguage.googleapis.com,GeminiAPI",
  "DOMAIN-SUFFIX,ai.google.dev,GeminiAPI",
  "DOMAIN-SUFFIX,aistudio.google.com,GeminiAPI",
 "DOMAIN-SUFFIX,gemini.google.com,GeminiAPI",
  // 自定义规则
...
function main(config) {
  ...
  config["proxy-groups"] = [
    ...
    },
    {
      ...
      "expected-status": "403", // 或 401，取决于无API Key时的响应
      "type": "select",
      "include-all": true,
      ...
      "icon": "https://fastly.jsdelivr.net/gh/clash-verge-rev/clash-verge-rev.github.io@main/docs/assets/icons/api.svg" // 自定义图标
    },
    {
      ...groupBaseOption,
      "name": "谷歌服务",
